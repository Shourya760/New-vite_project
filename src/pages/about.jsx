...
const About = () => {
  ...
  return (<div className="min-h-screen font-sans flex flex-col md:flex-row bg-gray-100">
    {/* Sidebar for Desktop */}
    ...
    {menuOpen && (<div className="md:hidden bg-yellow-400 text-white space-y-2 px-4 py-2">
    ...
    <main className="w-full md:w-4/5 p-6 md:p-12"> <section id="about"> <h1 className="text-3xl sm:text-5xl text-center font-bold border-b-4 border-black pb-4 mb-8 text-gray-800">ABOUT ME</h1>
      ...
      <div className="w-full flex justify-center space-x-4 mt-12">
        ...
        <button onClick={() => navigate("/resume")} className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 px-6 rounded-xl shadow transition duration-200" > Next Page </button>
      </div>
    </main>
  </div>
  );
